...
class SubstitutionCipherBreakerTests extends munit.FunSuite {
    test("SubstitutionCipherBreaker.break") {
        val ciphertext = "WNUTGKUTGKVTSSHQKZGFTOZVQLQWKOUIZEGSRRQNOFQHKOSQFRZITESGEALVTKTLZKOAOFUZIOKZTTFVOFLZGFLDOZIIOLEIOFFXMMSTROFZGIOLWKTQLZOFQFTYYGKZZGTLEQHTZITCOSTVOFRLSOHHTRJXOEASNZIKGXUIZITUSQLLRGGKLGYCOEZGKNDQFLOGFLZIGXUIF"
